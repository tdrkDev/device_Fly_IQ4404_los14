# Release name
PRODUCT_RELEASE_NAME := IQ4404

# Inherit some common CM stuff.
$(call inherit-product, vendor/cm/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/Fly/IQ4404/device_IQ4404.mk)
...
PRODUCT_DEVICE := IQ4404
PRODUCT_NAME := lineage_IQ4404
PRODUCT_BRAND := Fly
PRODUCT_MODEL := Fly IQ4404
